...
public class DanisAppApplication {
	...
	public class RoomController{
		...
		public void registerGuest (@PathVariable String firstName, String lastName, String country, String state, String city, String address, String email, String phoneNumber ){
			Guest guest1 = new Guest();
